...
plt.savefig(
    '{}/{}.jpg'.format("dataset_metrics", "amino_acid_counts"),
    transparent=True,
    dpi=400,
)
...
print(
    "3-grams occ <= 1000: ",
    len(
        np.array(list(n_gram_counts.values()))[
            np.array(list(n_gram_counts.values())) <= 1000]) /
    len(np.array(list(n_gram_counts.values()))))
print("Amino acids counts: ", n_gram_counts)
fig, ax = plt.subplots()
ax.bar((n_gram_counts.keys()), n_gram_counts.values())
ax.xaxis.set_major_locator(plt.MaxNLocator(15))
plt.savefig(
    '{}/{}.jpg'.format("dataset_metrics", "3gram_counts"),
    transparent=True,
    dpi=400,
)
...
plt.savefig(
    '{}/{}.jpg'.format("dataset_metrics", "3gram_most_common"),
    transparent=True,
    dpi=400,
)
...
labels = [
    'GO:0016491', 'GO:0022857', 'GO:0003677', 'GO:0003723', 'GO:0003735',
    'GO:0003746', 'GO:0003755', 'GO:0046872', 'GO:0046933', 'GO:0004867',
    'GO:0005198', 'GO:0005509', 'GO:0005524', 'GO:0008137', 'GO:0090729'
]
sizes = [
...
ax.axis('equal')
plt.savefig(
    '{}/{}.jpg'.format("dataset_metrics", "classes"),
    transparent=True,
    dpi=400,
)
